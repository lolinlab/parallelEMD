// Modification: 2022/Feb/07
// Silent the code
// Modify the kernal for finding extrema of the resultant IMFs (kernal name: extreme_amp)
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    */
    ...
    pure_emd(outMatrix,h_val,h_idx,h_len,upMatrix,lowMatrix,inMatrix, x_len, y_len, nm, nsift);
} 